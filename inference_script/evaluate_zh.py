...
def load_model(model_id, base_model, OPENMODEL_PATH):
...
class CEval(BaseEval):
    ...
    def get_task_names(self):
        ...
        # task_names = ["middle_school_mathematics", "high_school_mathematics"]
        return task_names
...
if __name__ == '__main__':
    ...
    parser.add_argument('--OPENMODEL_PATH', type=str, required=True)
    ...
    if model_id is not None:
        model, tokenizer = load_model(model_id, args.base_model, args.OPENMODEL_PATH)
